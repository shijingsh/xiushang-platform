package org.laokou.common.knife4j.config;
...
public class SwaggerKnife4jConfiguration {
    ...
    public SwaggerKnife4jConfiguration(OpenApiExtensionResolver openApiExtensionResolver) {
    ...
    private ApiInfo groupApiInfo(){
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("秀上",
                        "https://www.xiushangsh.com",
                        "xiushangsh@163.com"))
                .version("1.0.0")
                .build();
    }
